...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    var $recommendedPlugins = $(".wpwheels-dashboard-wrapper .starter-template-action a");
    if ($recommendedPlugins) {
      var $pluginInfo = $(".wpwheels-dashboard-wrapper .starter-template-plugins-info"),
      ...
      function processPlugins(_x) {
        return _processPlugins.apply(this, arguments);
      }
      function _processPlugins() {
        _processPlugins = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee($element) {
          var _iterator, _step, plugin, $pluginElement, actionType;
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                _iterator = _createForOfIteratorHelper(pluginData);
                _context.prev = 1;
                _iterator.s();
              case 3:
                ...
                plugin = _step.value;
                $pluginElement = $(plugin), actionType = $pluginElement.data("action");
                if (!actionType) {
                  _context.next = 16;
                  break;
                }
                ...
                _context.next = 11;
                return activatePlugin($pluginElement, $element);
              case 11:
                _context.next = 16;
                break;
              case 13:
                if (!(actionType === "wpentrepreneur_install_plugin")) {
                  _context.next = 16;
                  break;
                }
                _context.next = 16;
                return installPlugin($pluginElement, $element);
              case 16:
                _context.next = 3;
                break;
              case 18:
    ...
    function installPlugin($element) {
      var $targetElement = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "";
      if (!$targetElement) $targetElement = $element;
        ...
        $.ajax({
          ...
          success: function success(response) {
            ...
            if (response.success) {
              ...
              activatePlugin($element, $targetElement).then(function () {
                resolve();
