...
<h4 class="wp-block-heading has-base-color has-text-color">Contact Us</h4>
<!-- /wp:heading -->
...
<div class="wp-block-group"><!-- wp:separator {"backgroundColor":"secondary","className":"is-style-separator-dotted"} -->
