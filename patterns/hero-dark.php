...
<p class="has-secondary-color has-text-color has-primary-font-family has-medium-font-size wow animate__animated animate__bounce" style="font-style:normal;font-weight:500;letter-spacing:6px">Leverage Your Future</p>
<!-- /wp:paragraph -->
...
<h2 class="wp-block-heading has-secondary-color has-text-color has-link-color has-times-new-roman-font-family wow animate__animated animate__fadeInLeft" style="padding-bottom:20px;font-size:5rem;letter-spacing:5px">It's me <mark style="background-color:rgba(0, 0, 0, 0)" class="has-inline-color has-highlight-color-color">LOREM IPSUM</mark></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"fontFamily":"monospace"} -->
<p class="has-monospace-font-family">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam varius lorem in sem semper malesuada. Etiam eget urna tincidunt, hendrerit orci non, hendrerit odio. Mauris aliquam libero ac lacus consectetur posuere.</p>
<!-- /wp:paragraph -->
